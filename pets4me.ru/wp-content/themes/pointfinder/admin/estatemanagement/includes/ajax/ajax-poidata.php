						...
						foreach($pfformvars as $pfformvar => $pfvalue){
							...
							switch($thiskeyftype){
								...
								case '4':/*text field*/
									...
									switch ($target) {
										case 'title':
												$args['search_prod_title'] = html_entity_decode($pfvalue);
											break;

										case 'description':
												$args['search_prod_desc'] = html_entity_decode($pfvalue);
											break;

										case 'title_description':
												$args['search_prod_desc_title'] = html_entity_decode($pfvalue);
											break;
