					...
					'fields' => array(
						...
						array(
							...
							array(
								'id' => 'st4_sp_med5',
								'type' => 'button_set',
								'title' => esc_html__('Coordinate Validation', 'pointfindert2d') ,
								'options' => array(
									'1' => esc_html__('Enable', 'pointfindert2d') ,
									'0' => esc_html__('Disable', 'pointfindert2d')
								) ,
								'default' => '0',
								'desc' => esc_html__('If this enabled, system will use Google Map API key and validate coordinates. IMPORTANT: Please make sure you fill the server api key from Options Panel > Map Settings section.', 'pointfindert2d') ,
							) ,
						array(
				...
				**/
				$this->sections[] = array(
					...
					'fields' => array(
						...
						array(
							'id' => 'dragiconstatusm',
							'title' => esc_html__('Map Drag Status (Mobile)', 'pointfindert2d') ,
							'type' => 'button_set',
							'options' => array(
								1 => esc_html__('Locked', 'pointfindert2d'),
								0 => esc_html__('Unlocked', 'pointfindert2d')
